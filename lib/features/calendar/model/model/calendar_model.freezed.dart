...
class _$CalendarModelImpl implements _CalendarModel {
  ...
  @override
  String toString() {
    return 'CalendarModel(id: $id, title: $title, description: $description, date: $date, location: $location)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, date, location);
...
abstract class _CalendarModel implements CalendarModel {
  const factory _CalendarModel(
      ...
      @JsonKey(name: 'location') final String? location}) = _$CalendarModelImpl;
